...
public class VideoAdminController {
    ...
    public R uploadVideo(MultipartFile file){
        ...
        try {
            ...
            UploadStreamRequest request = new UploadStreamRequest(
                    "LTAI5tQXcwwLuvwSv7VU1fTd",
                    "5Q37CNkH8hjdwjrUbeglSYLP45giVN",
                    title,
                    originalFilename,
                    inputStream
            );
    ...
    public R delVideo(@PathVariable("videoId") String videoId){
        ...
        try {
            //*初始化客户端对象
            DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tQXcwwLuvwSv7VU1fTd",
                    "5Q37CNkH8hjdwjrUbeglSYLP45giVN");
            //*创建请求对象（不同操作，类不同）
    ...
    public R getPlayAuth(@PathVariable String vid){
        try {
            //（1）创建初始化对象
            DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tQXcwwLuvwSv7VU1fTd", "5Q37CNkH8hjdwjrUbeglSYLP45giVN");
